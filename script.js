...
function toggleDressMenu() {
    var menu = document.getElementById("dressMenu");
...
function toggleBoyMenu() {
    var menu = document.getElementById("boyMenu");
...
function toggleGirlMenu() {
    var menu = document.getElementById("girlMenu");
